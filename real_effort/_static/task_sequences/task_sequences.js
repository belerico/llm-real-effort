/*
Same WebSocket protocol as count_numbers/task_decoding, but the puzzle is
displayed as text (a number sequence) instead of an image.
*/

let isFrozen = false;
let questionEl = document.getElementById('question-txt');
